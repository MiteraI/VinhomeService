...
public class ProfileController {
    ...
    public ResponseEntity<CreateErrorCatcher> changeProfile(@RequestBody JsonNode request, @PathVariable("userId") Long userId, HttpServletRequest request_) throws Exception {
        int roleCustomer = 0;
